...
export const SKILLS = [
  {
    group: "On-Page & Technical SEO",
    desc: "Foundations that help search engines find, crawl, and rank you.",
    items: [
      "Keyword Research & Mapping",
      "On-Page Optimization",
      "Site Audits & Crawl Fixes",
      "Schema Markup",
      "Core Web Vitals",
  ...
  {
    group: "Local SEO",
    desc: "Visibility where customers actually search — nearby.",
    items: [
  ...
  {
    group: "Link Building",
    desc: "Authority earned through outreach, not shortcuts.",
    items: [
  ...
  },
  {
    ...
    desc: "Data-backed decisions that move rankings and revenue.",
    items: [
  ...
  },
  {
    ...
    desc: "Growing reach and engagement across platforms.",
    items: [
      "Content Calendars",
